        ...
        <div className='grid lg:grid-cols-12 gap-8'>
          <div className='relative lg:col-span-5 rounded-lg overflow-hidden'>
            <div className='bg-white rounded-lg shadow-sm border border-gray-300 p-6 pt-1'>
              ...
              <button onClick={()=>{toast.promise(saveResume, {loading: 'Saving...'})}} className='bg-gradient-to-br from-indigo-100 to-indigo-200 ring-indigo-300 text-blue-700 ring hover:ring-blue-400 transition-all rounded-md px-6 py-2 mt-6 text-sm'>
                Save Changes
              </button>
            </div>
          </div>
